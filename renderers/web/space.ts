...
import { NodeBuilder } from '@lukekaalim/act-backstage/builder.ts';
...
export const createWebNodeBuilder = (root: HTMLElement): NodeBuilder<HTMLElement | SVGElement | Text, 'web:html' | 'web:svg'> => ({
